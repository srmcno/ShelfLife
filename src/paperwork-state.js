...
const sceneLabels = { court: 'Verdict', outing: 'Expedition report', market: 'Market receipt', visitor: 'Visitor record', residency: 'Resident milestone', saga: 'Household subplot' };
