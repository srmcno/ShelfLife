...
export const TRAIT_PROP_AFFINITY = {
  spiteful:    { box: 3, mirror: 1, musicbox: -1 },
  damp:        { tub: 3, plant: 2, fern: 1, mat: 1, bell: -2 },
  management:  { box: 2, trophy: 1, board: -1 },
  loadbearing: { bell: 2, yarn: -1, globe: -1, coffinbed: -2 },
  haunted:     { mirror: 3, board: 3, urn: 3, candle: 2, skull: 2, clock: 2, phone: 2, lamp: -2 },
  theatrical:  { mirror: 3, musicbox: 2, trophy: 1, box: -1 },
  nocturnal:   { lamp: -3, candle: 2, coffinbed: 2, globe: 1 },
  magpie:      { globe: 3, mirror: 2, bell: 2, birdcage: 2, trophy: 1, clock: 1, fern: -1 },
  unblinking:  { mirror: 3, skull: 2, globe: 1, bell: 1 },
  sugar:       { bowl: 3, fern: -1, plant: -1 },
  complaints:  { box: 3, lamp: 1, mirror: -1 },
  terminal:    { coffinbed: 3, urn: 3, candle: 2, skull: 1, clock: 1, trophy: -1 },
  clean:       { tub: 3, bell: 2, bowl: -1, fern: -2, plant: -2 },
  feral:       { yarn: 3, bowl: 2, mat: 2, fern: 1, tub: -3, bell: -3, birdcage: -3 },
  cult:        { candle: 3, board: 3, skull: 2, urn: 2, mirror: 1 },
  doom:        { board: 2, clock: 2, mirror: 1, candle: 1, urn: 1, globe: -1 },
  clingy:      { coffinbed: 2, lamp: 2, phone: 2, musicbox: 1, mat: 1, bell: -2 },
  taxidermy:   { skull: 3, trophy: 3, urn: 2, birdcage: 2, fern: 1, plant: 1 },
  amnesiac:    { globe: 2, mirror: 2, board: 1, box: -1 },
  gossip:      { phone: 3, board: 2, box: 2, mirror: 1, clock: 1, bell: -1 },
  ancient:     { skull: 3, urn: 3, board: 2, clock: 2, musicbox: 1, candle: 1, globe: -1, phone: -2 },
  glitter:     { globe: 3, mirror: 2, tub: -2 },
  litigious:   { box: 3, board: 1, mirror: -1 },
  narcissist:  { mirror: 3, trophy: 2, globe: 1, box: -1 },
  paranoid:    { bell: 2, skull: 1, clock: 1, board: -2, mirror: -2, phone: -3 },
  influencer:  { mirror: 3, lamp: 2, globe: 2, skull: -1 },
  landlord:    { mat: 3, trophy: 2, coffinbed: 1, box: 1, bowl: 1, clock: 1 },
  hoarder:     { box: 3, fern: 2, globe: 2, yarn: 2, plant: 1 },
  martyr:      { coffinbed: 2, candle: 2, mirror: 1, musicbox: -1 },
  revisionist: { board: 1, box: 1, mirror: -2 },
  cryptid:     { fern: 3, plant: 2, birdcage: 2, globe: 1, mirror: -2, phone: -2, lamp: -3 },
  closer:      { box: 2, trophy: 2, board: 1 },
  doomscroll:  { mirror: 2, globe: 2, board: 1, lamp: -1 },
  freegan:     { bowl: 3, fern: 2, plant: 1, tub: -1 },
  astrology:   { candle: 3, board: 2, globe: 2, mirror: 1 },
  witness:     { board: 2, box: 2, mirror: 2, bell: 1 },
  steward:     { box: 3, bowl: 2, trophy: -1 },
  critic:      { bowl: 3, box: 2, plant: -1 },
  napoleon:    { trophy: 3, coffinbed: 2, board: 1, bell: -1 },
  prophet:     { board: 3, candle: 3, skull: 2, globe: 1 },
  cursed:      { mirror: 2, board: 2, candle: 1, bell: -2 },
  socialite:   { musicbox: 3, phone: 3, mirror: 2, mat: 2, bowl: 1, coffinbed: -1 },
  minimalist:  { bell: 2, skull: 1, birdcage: 1, mat: -1, clock: -2, fern: -2, yarn: -2, trophy: -2, box: -3, globe: -3 },
  timeshare:   { coffinbed: 2, trophy: 1, box: 1, board: -1 },
  nihilist:    { candle: 2, coffinbed: 2, globe: 1, board: -2, box: -2 },
  method:      { mirror: 3, trophy: 2, skull: 2, board: 1 }
};
