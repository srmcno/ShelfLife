...
export const ACTIVITIES = [
  ...
  { id: 'outing', title: 'Beyond the shelf', kind: 'Adventure', time: '3 decisions', icon: 'map', line: 'Bring a friend. It improves your odds of being the survivor.', detail: 'Choose a crew, ration nerve and use your tool at the right stop. Optional wagers, route-specific scenery and nine relics.', life: 'outing' },
  { id: 'court', title: 'Shelf Court', kind: 'Detective', time: 'No timer', icon: 'scales', line: 'Presumed innocent. Deeply resented for it.', detail: 'Search the crime scene, press specific witness claims and expose concealed motives with physical evidence. Build your case, appeal mistakes and resume anytime.', life: 'court' },
