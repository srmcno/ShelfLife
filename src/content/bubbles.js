...
export const MOOD_BUBBLES = {
  content: [
    ...
    'i could go another day.', 'they remembered. noted.', 'no biting till after the cuddle.',
    ...
    'everything is where i left it.', 'smug, technically.', 'fed. the moth can go.',
    ...
    'crumb secured.', 'warm enough to fake a pulse.', 'i was picked up first.',
    'glazed and pleased.', 'dust settling. let it.', 'the light is on my side.',
    'no notes today. none.', 'the bite was affectionate.', 'my square. my dust.',
    ...
    'a cuddle. teeth tucked in.', 'the lamp warmed my bad side.', 'forever, but the warm sort.'
  ],
  fine: [
    ...
    'a crumb went past.', 'counted the slots. eighteen.', 'my coffin could be a pencil case.',
  ...
  annoyed: [
    ...
    'i was counted last.', 'the urn gets a nicer cloth.', 'four inches of no thank you.',
  ...
  furious: [
    ...
    'teeth first. questions after.', 'move me and see.', 'slot nine will be avenged.',
...
export const NOTICE_BUBBLES = [
  ...
  'hello. slot nine has notes.', 'you smell of the kitchen.', 'back before the wake. awkward.',
...
export const TRAVEL_BUBBLES = [
  ...
  'slot nine or bust.', 'following the smell of a grudge.', 'four inches at a time.', 'past the crumb. do not look.',
