...
export const COMPLAINTS = {
  food: {
    annoyed: [
      ...
      'Has licked the shelf down to a previous owner’s varnish. Prefers that one.',
      ...
      'Has dressed a crumb in dust to make it look bigger. Ate the coat first.',
      ...
      'Is giving the last crumb a funeral. The burial is mouth-first.',
      'Found a raisin under the bracket. Told it to stop pretending to be a relative.',
      ...
      'Has bitten the painted biscuit on its bowl. The bowl is down a biscuit.',
      'Held a séance for the last crumb. Asked it whether there were more where it went.',
    ...
    furious: [
      ...
      'Has eaten its menu. It is asking whether the dessert page was edible too.',
      ...
      'Tried to look like it was wasting away. Its mould only allows the one shape.',
      ...
      'Has eaten the note about being hungry. Requests a thicker paper next time.',
      'Is chewing the plank at the bracket end. The plank has started to lean.',
      'Ate the dirt off its feet. Sat back down. Ate the same dinner again.'
    ]
  },
  fuss: {
    annoyed: [
      ...
      'Pretended to faint into your palm. Missed the palm. Is still committed to the faint.',
      'Rehearsed a conversation with you and got both parts wrong.',
      'Has practised looking abandoned. Used the mirror. Abandoned the mirror too.',
      ...
      'Wrote “FREE TO GOOD HAND” on its nameplate. Underlined hand.',
      ...
      'Has put itself in a tissue like a little parcel. The parcel keeps clearing its throat.',
    ...
    furious: [
      ...
      'Is pretending to be dead for attention. Forgot to stop correcting your dusting.',
      ...
      'Has replaced your drawn portrait with a thumb. Says it has kept the useful bit.',
      'Practised biting the hand that feeds it. Practised the apology with its mouth full.',
      'Has turned its nameplate to the wall as well. The whole slot is facing away.',
      'Made itself a headstone from a crumb. Ate it halfway through the sobbing.',
      ...
      'Dug itself a little grave in the dust. Refuses to lie in it until you are watching.',
  ...
  clean: {
    annoyed: [
      ...
      'The mildew on its back has mildew. It is calling itself a grandparent.',
      'Smells like something died in a doll’s house and the doll covered it with a rug.',
      ...
      'Has a crumb stuck to its head. It bows whenever it wants a sniff of dinner.',
      ...
      'Has parted the dust on its head. The parting is cleaner than the face.',
      ...
      'Scratched its back. Something in the dust scratched back. It asked for the other side.'
    ],
    furious: [
      ...
      'Something lives underneath it. It complains about the noise upstairs.',
      'Pressed against the wall. Came away with wallpaper.',
      'Has begun to shine. Nothing clean shines like that.',
      'The bathwater tried to climb back onto it.',
      ...
      'There is a clean patch under one foot. It is standing on it to hide the shame.',
      ...
      'The fuzz on its side leans towards the light. It keeps turning it away, out of spite.',
      'Left an outline on the wood. Lay down inside it to see how a crime scene would suit it.',
      ...
      'A crumb is stuck to its stomach. It calls this meal prep and will bite the cloth.',
...
export const CARE_LINES = {
  food: [
    ...
    'Dragged dinner behind the bowl. You could still see all of it eating.',
    'Ate half. Put the other half underneath itself.',
    'Finished the crumb. Ran a tongue along your fingerprint for anything left.',
    'Licked the bowl until the bowl moved, then followed it.',
    'Ate with both hands. It has two hands today.',
    'Braced its feet against the bowl and pulled the crumb into its mouth.',
    'Ate it, turned the bowl over and waited for the chewing underneath to stop.',
    ...
    'Held a moment of silence for the crumb. Chewed through most of it.',
    'Ate it in the bowl, then ate the crumbs off the rim, then checked under the bowl.',
    'Took a bite larger than its head. Waited, politely, for the rest of its head to catch up.',
    'Ate lying down in the bowl. It now understands the appeal of an open casket.',
  ...
  fuss: [
    ...
    'Purred. An answering rattle came from inside the shelf.',
    'Turned itself over to be got at properly.',
    'Pressed its forehead against your nail and slid a loose tooth into your palm.',
    'Tried to purr. Sounded like something being dragged across a cellar. Kept going.',
    'Hid its teeth against your finger. For once, that is the reassuring arrangement.',
    'Went limp. The stitches held; everything inside moved to one end.',
    ...
    'Warmed in your hand. A second patch warmed beside it.',
  ...
  clean: [
    ...
    'Got inside the cloth and pulled the edges shut. The cloth started breathing.',
    'Washed behind its ears. Found a smaller set.',
    'Smells of nothing now. It preferred smelling of something.',
    'Came out spotless. Put a little dirt back on, for the resemblance.',
    'Lifted a fold for the cloth. There was a second fold underneath, facing the other way.',
    'Bit the cloth. Let it go when you found the itchy bit.',
    'Dried against your wrist. Left an outline with one finger too many.',
    ...
    'Came out a shade lighter. Asked whether you could wash off the expression too.',
    'Was rinsed. Something fell out that it insists was never part of it.',
    'Held its arms up. You wiped one, then the other, then the one behind.',
    'Stayed inside the cloth. You could hear it licking the side you had not used.',
...
export const OVERFED = {
  food: [
    ...
    'Is full and horizontal. Has requested flowers, in case it cannot get back up.',
    'Ate past the point of dignity and is not embarrassed.',
    'Has stopped fitting in the bowl.',
    'Has hidden the extra helping under itself. Looks like it is burying a relative badly.',
    'Swore on its life it could not eat another crumb. Immortal. Ate it.',
  ...
  fuss: [
    ...
    'Has been fussed so flat it could be posted. Is checking for a stamp.',
  ...
  clean: [
    ...
    'Is so clean it looks freshly made. Has to introduce itself through gritted teeth.',
    'Is worried you are trying to erase it. Keeps offering you the bad side first.',
