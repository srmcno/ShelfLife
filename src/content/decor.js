...
export const ROOMS = {
  ...
  mortuary: { name: 'Mortuary Mint', swatch: '#8FB5A4', vars: { '--room-a': '#A8C9B9', '--room-b': '#7FA492', '--panel-a': '#E4EDE4', '--panel-b': '#D2E0D4', '--line': '#8CA697', '--rule': '#A9BFB0', '--surface': '#DCE7DD', '--surface-hi': '#CBDACD', '--field': '#EDF3ED', '--bone': '#23302A', '--bone-dim': '#4E6357', '--wall-ink': 'rgba(200,232,212,.13)', '--room-key': '#C8E8D4' } },
  nursery: { name: 'Haunted Nursery', swatch: '#D9A7B0', vars: { '--room-a': '#E7BFC6', '--room-b': '#C08D98', '--panel-a': '#F3E2E4', '--panel-b': '#E5CED3', '--line': '#B98F98', '--rule': '#CFA9B1', '--surface': '#EEDCDF', '--surface-hi': '#E2C8CD', '--field': '#F7ECEE', '--bone': '#33202A', '--bone-dim': '#61454F', '--wall-ink': 'rgba(244,185,196,.13)', '--room-key': '#F4B9C4' } },
  ...
  parlor: { name: 'Bone Parlor', swatch: '#E8DFCE', vars: { '--room-a': '#F4EDDF', '--room-b': '#DCD2BE', '--panel-a': '#EFE7D6', '--panel-b': '#E2D8C4', '--line': '#BCAE95', '--rule': '#CFC3AB', '--surface': '#E7DECB', '--surface-hi': '#DBD0B9', '--field': '#F6F1E5', '--bone': '#2B2318', '--bone-dim': '#5D5241', '--wall-ink': 'rgba(255,217,160,.12)', '--room-key': '#FFD9A0' } },
