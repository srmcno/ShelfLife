...
export const MARKET_ERRANDS = [
  ...
  { id:'nest', name:'A comfort parcel', tags:['cozy','cozy'], brief:'Two separate comforts for a difficult evening. The recipient has cancelled its plans to be reasonable.', delivered:'Both comforts arrive. Their owner postpones a grievance until tomorrow. It has made a note not to enjoy this too much.' },
