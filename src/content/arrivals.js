...
export const ARRIVALS = [
  { id: 'mabel', name: 'Mabel', line: 'Keeps lying down in boxes that are not for her.',
  ...
  { id: 'pip', name: 'Pip', line: 'Eats the mourning clothes before the funeral.',
  ...
  { id: 'oswald', name: 'Oswald', line: 'Hollow inside. Says the knocking is none of your business.',
