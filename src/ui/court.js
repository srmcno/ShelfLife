...
function courtActionBar(game) {
 ...
 if(v.chapter==='investigation'){
  ...
  status=isClear?'Cleared. Choose another suspect.':game.version===3?'Clear only with a contradiction. An unsupported argument costs 5 case points; hints are free.':'Use a conflicting clue to clear this suspect.';
