...
export function renderScheme(state) {
  ...
  host.innerHTML = '<div class="scheme-heading"><span class="eyebrow">Small conspiracies</span><span class="live-dot">In progress</span></div><h2>' + esc(plan.definition.title) + '</h2>' +
