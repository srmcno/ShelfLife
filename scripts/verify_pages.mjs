...
try {
  for (const mobile of [false, true]) {
    ...
    try {
      ...
      await page.locator('#tabPlay').click();await page.locator('[data-activity="outing"]').click();
      ...
      await page.locator('#lifeClose').click();await page.locator('[data-tab="notes"]').click();await page.locator('[data-filter="papers"]').click();
